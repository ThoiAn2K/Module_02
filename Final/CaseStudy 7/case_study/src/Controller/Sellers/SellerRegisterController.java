...
import Model.Services.RegisterSellerServices;
import Model.Utils.Reader.ReadClient;
...
public class SellerRegisterController extends JFrame {
    public SellerRegisterController() {
        JPanel jPanel = new JPanel();
        setTitle("Register of Seller");
        ...
        JLabel shopName = new JLabel("Enter shop name");
        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                WriterSeller writerSeller = new WriterSeller();
                writerSeller.writerDataSellers(data);

                RegisterSellerServices registerSellerServices = new RegisterSellerServices();
                registerSellerServices.check(accounts);
            }
        });
